<template>
  <div class="jigsawContent">
    <h1>性感美女拼图大作战</h1>
    <div id="photo">
      <img src="../../../static/img/jigsaw/girl0/girl.jpg" class="selected">
      <img src="../../../static/img/jigsaw/girl1/girl.jpg" class="">
      <img src="../../../static/img/jigsaw/girl2/girl.jpg" class="">
    </div>
    <center><input type="button" value="开始游戏" @click="notify('计时开始！')"></center>
    <ul id="box"></ul>
  </div>
</template>
  ...
  mounted () {
    ...
    function GAME(ran) {
      ...
      for (i = 0; i < aData.length; i++) {
        ...
        oImg.src = '../../../static/img/jigsaw/girl' + imgPath + '/' + aData[i] + '.png'
        oLi.appendChild(oImg)
        oFragment.appendChild(oLi)
      }
      oBox.appendChild(oFragment)
      oBox.style.background = 'url(../../../static/img/jigsaw/girl' + imgPath + '/bg.png)  no-repeat'
      ...
      //  拖拽函数
      function drag (obj, handle1) {
        var handle = handle1 || obj
        handle.style.cursor = 'move'
        handle.onmousedown = function (event1) {
          var event = event1 || window.event
            ...
            if (oNear) {
              ...
              startMove(oNear, aPos[oNear.index], function () {
                if (finish()) {
                  ...
                  var info = '\u606d\u559c\u60a8\uff0c\u62fc\u56fe\u5b8c\u6210\uff01\u7528\u65f6\uff1a' + iHour + '\u5c0f\u65f6' + iMin + '\u5206' + iSec + '\u79d2'
                  $this.notify(info)
                  createMask()
                }
              })
